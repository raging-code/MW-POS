...
function buildReceipt(sale: SaleDetail, settings: Settings, width: PaperWidth): Uint8Array {
  ...
  // no peso glyph. "P" is in every printer's default font and prints
  // reliably. (The peso sign still displays correctly on-screen in the
  // app itself — this only affects the physical printed receipt.)
